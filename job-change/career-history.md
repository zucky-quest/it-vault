...
- ソースレビュー、新人のフォロー、社内LTを通じてチームの知識共有に貢献
- QCサークルのリーダーとして改善活動を推進し、廃却金額を月100万円削減

## 事実確認が必要な項目

- 各社・各プロジェクトの在籍期間
- AI支援サービスで担当した機能、チーム規模、成果指標
- AIエージェント・MCP導入による工数、品質、リードタイムなどの改善効果
- スクラムマスターとして担当した期間とチーム規模
