...
var ExampleSettingTab = class extends import_obsidian4.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian4.Setting(containerEl).setName("Non-empty Line Disabled").setDesc("The shortcut key `/` is only recognized at the first character of a blank line, ignoring lines of text in the input.").addToggle(
      (component) => component.setValue(this.plugin.settings.nonEmptyLineDisabled).onChange(async (value) => {
...
var TypingAsstPlugin = class extends import_obsidian7.Plugin {
  async loadSettings() {
    ...
    if (false) {
      console.log("commands======>", this.app.commands);
    }
  }
  async saveSettings() {
...
${codeStr}`,
    ...
    this.registerDomEvent(document, "keyup", (evt) => {
      ...
      if ((_c = this.commands) == null ? void 0 : _c.isVisible()) {
        if (!["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight"].includes(key)) {
          const view = this.app.workspace.getActiveViewOfType(import_obsidian7.MarkdownView);
          if (view) {
            const cursor = view.editor.getCursor();
            const editLine = view.editor.getLine(cursor.line);
            const _cmd = ((_d = editLine == null ? void 0 : editLine.match(/[^\/]*$/)) == null ? void 0 : _d[0]) || "";
            if (!editLine) {
              (_e = this.commands) == null ? void 0 : _e.hide();
            } else {
              (_f = this.commands) == null ? void 0 : _f.search(_cmd);
            }
            view.editor.focus();
          }
        }
      }
      (_g = this.btns) == null ? void 0 : _g.hide();
    });
    const renderPlugin = () => {
      var _a, _b, _c, _d, _e;
