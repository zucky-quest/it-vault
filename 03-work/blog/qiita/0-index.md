...
5. [[git-commands-guide]] - Gitでよく使うコマンド一覧と使い方【初心者向け】
6. [[mistake-prevention-with-scrum-and-ai]] - 「以後気をつけます」をレトロで終わらせない —— 失敗学 × スクラム × AIレビューでミスを仕組み化する
7. [[problem-and-issue]] - 問題と課題の違いを理解して、適切な解決手法を選択しよう
